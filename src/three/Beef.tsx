...
const Beef: React.FC<BeefPropType> = ({ sectionRef, setShowText }) => {
  ...
  useEffect((): void => {
    ...
    control.object.position.y = 4;
    control.object.position.z = 7;
  ...
  useEffect(() => {
    const windowScrollListner = () => {
      ...
      if (scrollDegree >= 0 && scrollDegree < 0.2) {
        ...
        gsap.to(group.rotation, 0.3, {
          x: 0,
          y: 0 + angleToRadians(120) * scrollDegree,
          z: 0,
          ease: "linear",
        });
        ...
        gsap.to(group.rotation, 0.3, {
          x: 0,
          y: angleToRadians(120) + angleToRadians(120) * scrollDegree,
          z: 0,
          ease: "linear",
        });
        ...
        gsap.to(group.rotation, 0.3, {
          x: 0,
          y: angleToRadians(240) + angleToRadians(120) * scrollDegree,
          z: 0,
          ease: "linear",
        });
      }
